...
// eslint-disable-next-line
const REGEX_CRAWLER = /bot|spider|facebookexternalhit|simplepie|yahooseeker|embedly|quora link preview|outbrain|vkshare|monit|Pingability|Monitoring|WinHttpRequest|Apache-HttpClient|getprismatic\.com|python-requests|Twurly|yandex|browserproxy|crawler|Qwantify|Yahoo! Slurp|pinterest|Tumblr\/14\.0\.835\.186|Tumblr Agent 14\.0/i;

function isCrawler(a) {
